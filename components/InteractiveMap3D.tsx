...
const InteractiveMap3D: React.FC<InteractiveMap3DProps> = ({
  coordinates,
  ...
  // Generar URL de Google Maps embebido sin API key
  const getMapsEmbedUrl = () => {
    // Usar una URL de Google Maps que funciona sin API key
    // Esta es una URL específica para Calle Jerusalén que funciona
    return `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1000!2d-84.07814492!3d10.02193128!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTDCsDAxJzE5LjAiTiA4NMKwMDQnNDEuMyJX!5e0!3m2!1ses!2scr!4v${Date.now()}!5m2!1ses!2scr`;
  };
      ...
      <div className="absolute top-0 left-0 right-0 z-10 bg-gradient-to-b from-black/70 to-transparent p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <select
              value={mapType}
              onChange={(e) => setMapType(e.target.value as 'satellite' | 'hybrid' | 'terrain')}
            ...
            >
              ...
              <option value="hybrid" className="text-gray-900">Híbrido</option>
        ...
        <div className="absolute bottom-4 left-4 right-4 z-10">
          <div className="bg-black/70 text-white p-3 rounded-lg text-sm">
            <p className="text-center">
              💡 Usa el mouse para hacer zoom y explorar la vista {mapType === 'satellite' ? 'satelital' : mapType === 'hybrid' ? 'híbrida' : 'de terreno'}
            </p>
          </div>
        </div>
      )}
